...
(function () {
  ...
  _.each = function (collection, iterator) {
    if (Array.isArray(collection)) {
      ...
      for (var _i = 0; _i < props.length; _i++) {
        iterator(collection[props[_i]], props[_i], collection);
      }
    }
  };
  ...
  _.filter = function (collection, test) {
    ...
    _.each(collection, function (element, prop, object) {
  ...
  _.reject = function (collection, test) {
    return _.filter(collection, function (element, prop, object) {
      return !test(element, prop, object);
    });
  };
  ...
  _.every = function (collection) {
    var iterator = arguments.length <= 1 || arguments[1] === undefined ? _.identity : arguments[1];
  ...
  _.extend = function () {
    for (var _len = arguments.length, collection = Array(_len), _key = 0; _key < _len; _key++) {
      collection[_key] = arguments[_key];
    }

    for (var i = 1; i < collection.length; i++) {
      var props = Object.keys(collection[i]);
...
//# sourceMappingURL=transpiledUnderbar.js.map
